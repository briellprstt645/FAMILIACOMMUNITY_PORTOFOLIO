...
interface RotatingTextProps extends Omit<HTMLMotionProps<"span">, "children" | "transition"> {
  texts: string[]
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  const elements: WordSegment[] = useMemo(() => {
    ...
    <motion.span className={cn("text-rotate", mainClassName)} {...rest} layout transition={transition}>
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        <motion.span
          ...
          aria-hidden="true"
        >
          {elements.map((wordObj: WordSegment, wordIndex: number, array: WordSegment[]) => {
            const previousCharsCount = array
              .slice(0, wordIndex)
              .reduce((sum: number, word: WordSegment) => sum + word.characters.length, 0)
            return (
                  ...
                  <motion.span
                    ...
                    transition={{
                      ...
                      delay: getStaggerDelay(
                        ...
                        array.reduce((sum: number, word: WordSegment) => sum + word.characters.length, 0),
                      ),
                    }}
